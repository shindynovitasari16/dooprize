...
<body class="hold-transition fixed skin-blue sidebar-mini"></body>
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="gath.php"><i class=""></i> Detail Event</a></li>
      </ol>
    </section>
    ...
    <a href="../1234/dooprize/index.php">
      <div class="btn btn-app">
        <i class="fa fa-star"></i> Doorprize
      </div>
    </a>

    <div class="row margin-bottom">
      <div class="col-sm-6">
        <img class="img-responsive" src="gath.jpg" alt="Photo">
      </div>
