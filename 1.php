...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <a class="btn btn-app" href="tambah.php">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a  class="btn btn-social-icon"  href="ubah.php?user_id=<?= $row["user_id"];?>"><i class="fa fa-edit"></i></a>
                          |
                        <a class="btn btn-social-icon btn-google" href="hapus.php?user_id=<?= $row["user_id"];?>" onclick="return confirm('yakin?');"><i class="fa fa-remove"></i></a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                  <?php endforeach; ?>
