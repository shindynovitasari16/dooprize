...
$(".editButton").click(function(){
            ...
            var alamat = bodyElement.find("#alamatUser").text();
...
$("#saveButton").click(function(){
    ...
    $.ajax({
        type: "POST",
        url : "./php/random.php",
        data : { update: "", id: id, nama: nama,alamat: alamat, kelas: kelas, ikut: ikut},
        success : function(){
            $('#modal1').closeModal();
            swal({
                title : "Berhasil!",
...
$("#addButton").click(function(){
    ...
    $.ajax({
        type: "POST",
        url : "./php/random.php",
        data : { add: "", nama: nama, alamat: alamat, kelas: kelas, ikut: ikut},
        success : function(){
            $('#modal1').closeModal();
            swal({
                title : "Berhasil!",
