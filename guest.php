    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
            ...
            <li class="active"><a href="profile.php"><i class="fa fa-male"></i> <span>PROFIL</span></a></li>
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <?php foreach ($users as $row):?>
                <a href="1.php">
                <div class="widget-user-header bg-black" style="background: url('photo1.png') center center;">
                    <h3 class="widget-user-username"><?= $row["event"];?></h3>
                    <h5 class="widget-user-desc">Maneger</h5>
                </div>
                <div class="widget-user-image">
                    <img class="img-circle" src="avatar.png" alt="User Avatar">
                </div>
                </a>
                ...
                <div class="row">
                    ...
                    <div class="description-block">
                        ...
                        <span class="description-text">Total Guest</span>
                    </div>
                    <!-- /.description-block -->
                    </div>
                    <!-- /.col -->
                    ...
                    <div class="description-block">
                        ...
                        <span class="description-text">Guest Capacity</span>
                    </div>
                    <!-- /.description-block -->
                    </div>
                    <!-- /.col -->
